...
test('CommentList calls getComments when not paginating', function () {
    ...
    $component = livewire(NoteList::class, [
        'record' => $post,
        'paginate' => false,
    ]);
...
test('CommentList can render non-Comment renderable items', function () {
    ...
    $items = collect([
        new RenderableNote(id: 1, authorName: 'System', body: 'System notice 1'),
        new RenderableNote(id: 2, authorName: 'Bot', body: 'Automated message'),
    ]);
...
test('CommentList can render both Comment and RenderableComment items', function () {
    ...
    $renderable = new RenderableNote(id: 99, authorName: 'System', body: 'System message');
