...
use Kirschbaum\Commentions\Events\NoteWasCreatedEvent;
...
test('can create a comment', function () {
    ...
    Event::assertDispatched(NoteWasCreatedEvent::class, function ($event) use ($post, $user) {
...
test('guests cannot create comments', function () {
    ...
    Event::assertNotDispatched(NoteWasCreatedEvent::class);
});
