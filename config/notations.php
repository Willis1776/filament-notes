...
return [
    ...
    */
    'note' => [
        'model' => \Willis1776\Notations\Note::class,
        'policy' => \Willis1776\Notations\Policies\NotePolicy::class,
    ],
    ...
    */
    'subscriptions' => [
        ...
        'dispatch_as_mention' => env('NOTATIONS_SUBSCRIPTIONS_DISPATCH_AS_MENTION', false),
        // Controls whether the subscribers list is shown in the sidebar UI
        'show_subscribers' => env('NOTATIONS_SUBSCRIPTIONS_SHOW_SUBSCRIBERS', true),
        // Automatically subscribe the author when they add a comment
        'auto_subscribe_on_comment' => env('NOTATIONS_SUBSCRIPTIONS_AUTO_SUBSCRIBE_ON_COMMENT', true),
        // Automatically subscribe a user when they are mentioned in a comment
        'auto_subscribe_on_mention' => env('NOTATIONS_SUBSCRIPTIONS_AUTO_SUBSCRIBE_ON_MENTION', true),
    ],
    ...
    */
    'notifications' => [
        'mentions' => [
            ...
            'notification' => \Kirschbaum\Commentions\Notifications\UserMentionedInNote::class,
